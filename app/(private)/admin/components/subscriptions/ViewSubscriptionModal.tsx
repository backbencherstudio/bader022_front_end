      ...
      <DialogContent className="sm:max-w-md">
        ...
        {isLoading ? (
          ...
          <div className="space-y-3">
            <p>
              <strong>Business:</strong> {data?.data?.user?.name}
            </p>
            <p>
              <strong>Email:</strong> {data?.data?.user?.email}
            </p>
            <p>
              <strong>Plan:</strong> {data?.data?.plan?.name}
            </p>
            <p>
              <strong>Price:</strong> {data?.data?.plan?.price}
            </p>
            <p>
              <strong>Status:</strong> {data?.data?.status}
            </p>
            <p>
              <strong>Start:</strong> {data?.data?.starts_at}
            </p>
            <p>
              <strong>End:</strong> {data?.data?.ends_at}
            </p>
