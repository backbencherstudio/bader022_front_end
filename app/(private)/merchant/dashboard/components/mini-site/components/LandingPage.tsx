...
export default function LandingPage() {
  ...
  return (
    <div
      ...
      className="bg-gray-50 dark:bg-gray-800 dark:text-white border-r border-gray-200 dark:border-gray-700 space-y-1  overflow-y-auto shadow my-3 p-3 rounded-md"
    >
      {/* HERO */}
      <Hero />
      {/* About Section */}
