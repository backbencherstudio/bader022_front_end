...
//   return (
//     <DialogContent className="max-w-225 p-0 overflow-auto rounded-2xl">
//       {/* Header */}
//       <DialogHeader className="flex flex-row items-start justify-between px-7 py-5 bg-[#F4F6F8] border-b border-border">
//         <div>
//           <DialogTitle className="text-lg font-semibold text-[#0B1220]">
//             Reschedule Appointment
//           </DialogTitle>
//           <p className="text-sm text-[#637381] mt-1">Haircut & Styling</p>
//         </div>
//       </DialogHeader>
...
//             <div className="bg-[#F4F6F8] px-6 py-4 text-sm font-semibold text-[#0B1220]">
//               Select Date
//             </div>
...
//               {/* Days */}
//               <div className="grid grid-cols-7 gap-y-5 text-sm text-[#0B1220]">
//                 {Array.from({ length: 28 }, (_, i) => i + 1).map((day) => (
//                   <button
//                     key={day}
//                     className={`h-9 w-9 mx-auto rounded-lg flex items-center justify-center transition
//                       ${
//                         day === 19
