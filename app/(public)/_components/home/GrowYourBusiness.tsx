      ...
      <section className="relative container">
        <div className="relative z-10 container mx-auto px-4 py-16 md:py-20">
          <div className="mx-auto text-center">
            {/* Title */}
            <motion.h1
              className="text-[28px] leading-tight text-white md:text-[44px] xl:text-[60px] md:leading-[1.2] font-bold"
            ...
            {/* Subtitle */}
            <motion.p
              className="mt-4 text-[16px] md:text-[18px] text-white leading-relaxed"
              variants={textVariant}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: false, amount: 0.7 }}
