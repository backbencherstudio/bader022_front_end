...
//   };
//   console.log("rows value =>", t("FeatureComparison.rows"));
    ...
    <section className="container mx-auto py-20 px-4">
      ...
      <div className="grid md:grid-cols-[1fr_1.15fr] gap-10 max-w-6xl mx-auto">
        ...
        >
          {/* Badge */}
          <div className="flex justify-end pt-3">
            <span className="bg-linear-to-r gap-2 text-white flex justify-center items-center w-40 from-blue-500 to-indigo-500 px-4 py-1 rounded-full text-sm font-medium shadow">
              <Star /> Most Popular
            </span>
          </div>
