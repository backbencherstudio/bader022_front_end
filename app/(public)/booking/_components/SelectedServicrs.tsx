...
export default function SelectedServicrs({ onNext }: Step3Props) {
            ...
            <div className="p-5 space-y-3">
              ...
              <div className="flex gap-3 pt-3">
                <button
                  ...
                  //   setOpenModal(true);
                  // }}
                  className="flex-1 flex items-center justify-center gap-2 hover:bg-gray-900 dark:bg-blue-600 hover:text-white py-2 rounded-lg text-sm"
                >
                  Book Now
                </button>
